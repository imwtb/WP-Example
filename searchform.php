...
<form role="search" <?php echo $aria_label; ?> method="get" class="search__form" action="<?php echo esc_url(home_url('/')); ?>">
  ...
  <input type="search" id="<?php echo esc_attr($unique_id); ?>" class="search__field" placeholder="<?php esc_attr_e('搜索', 'example-text'); ?>" value="<?php echo get_search_query(); ?>" name="s" />
